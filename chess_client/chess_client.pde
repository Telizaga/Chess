...
void pawnpromotion(){
  ...
  image (brook,240,250,100,100);
  image (bbishop,425,250,100,100);
  image (bknight,240,435,100,100);
  image (bqueen,425,435,100,100);
  ...
  if (dist(mouseX,mouseY,290,300)<50 &&ppm&&ykey){
    ...
    ppm=false;
    New='R';
    myClient.write(row1 + ","+col1+","+row2+","+col2+","+moves+","+New+","+back+",");
    moves=0;
  }
